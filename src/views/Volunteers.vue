    ...
    <transition name="fade">
      ...
      >
        <div class="bg-white dark:bg-gray-800 p-4 md:p-6 rounded shadow w-full max-w-md max-h-[90vh] overflow-y-auto">
          ...
          <p class="mb-2"><strong>العمر:</strong> {{ selectedVolunteer.age }}</p>
          <p class="mb-2"><strong>الموقع:</strong> {{ selectedVolunteer.location }}</p>
          <p class="mb-2"><strong>الوقت المتاح:</strong> {{ selectedVolunteer.availability }}</p>
          <p class="mb-2"><strong>البريد الإلكتروني:</strong> {{ selectedVolunteer.email }}</p>
          <p class="mb-2"><strong>المهارات:</strong> {{ selectedVolunteer.skills.join(', ') }}</p>
